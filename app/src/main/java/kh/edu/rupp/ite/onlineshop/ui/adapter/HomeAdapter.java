...
public class HomeAdapter extends ListAdapter<Products, HomeAdapter.ProductViewHolder> {
    public HomeAdapter() {
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolderHomeBinding itembinding;
        public ProductViewHolder(ViewHolderHomeBinding itembinding) {
        ...
        public void bind(Products products) throws IOException {
            ...
            itembinding.productname.setText(products.getName());
